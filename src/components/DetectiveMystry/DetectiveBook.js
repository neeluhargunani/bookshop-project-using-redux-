...
const DetectiveBook = () => {
     const {products} = useSelector(state => state.ProductsDetectiveReducer);
    return (
        ...
        {products.map(product=>(
         ...
         <Link to={`/detectivedetails/${product.id}`}><img src={`/images/${product.image}`} alt="product_image" className="img-thumbnail"/>
      </Link>
        </div>
